...
@foo = VMS::ProcInfo::proc_info_names;
if (scalar(@foo) > 0) {
  print "ok 2\n";
} else {
  print "not ok 2\n";
...
$NodeName = VMS::ProcInfo::get_one_proc_info_item($$, "NODENAME");
...
tie %testhash, VMS::ProcInfo, $$ or print "not ";
print "ok 4\n";
...
if (!defined($foo = VMS::ProcInfo::get_all_proc_info_items($$))) {
  print "not ";
};
print "ok 6\n";
